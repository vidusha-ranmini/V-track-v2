...
CREATE TABLE IF NOT EXISTS members (
    ...
    land_house_status TEXT CHECK (land_house_status IS NULL OR land_house_status IN ('plot_of_land', 'no_house', 'no_house_and_land', 'land_and_house')),
    whatsapp_number TEXT,
    is_drug_user BOOLEAN DEFAULT FALSE,
    is_thief BOOLEAN DEFAULT FALSE,
    mahapola BOOLEAN DEFAULT FALSE,
    aswasuma BOOLEAN DEFAULT FALSE,
    wadihiti_dimana BOOLEAN DEFAULT FALSE,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    is_deleted BOOLEAN DEFAULT FALSE
);
